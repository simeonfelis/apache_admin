# Django settings for lab_regime project.
import os
...
MEDIA_ROOT = os.path.join(DEPLOY_PATH, 'static')
...
SECRET_KEY = 't332f(j-^mpqplk5!+1vj9cpg#0_#h)%r5_hg%gemww_g*-hwt'
...
ROOT_URLCONF = 'lab_regime.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lab_regime.wsgi.application'
